  ...
  return (
    <div className='navContainer'>
      <div className="navleft">
        ...
        <h1>Car<span>Sales</span></h1></div>
        <div className="mob-right">

          {isLoggedIn && <>
          <div className="cart-edit mob-cart" style={{ position: "relative", height: "10px", justifyContent: "center", alignItems: "center" }}><Link className='nav-link' to="/cart"><FiShoppingCart size={24} />
</Link>{cart.length > 0 && (
              <span
                style={{
                  position: "absolute",
          ...
          <button id='b1' onClick={logout}>Log Out</button></>}
        </div>
      ...
      <div className={`navright ${open ? "open" : ""}`}>
        ...
        {isLoggedIn ?
          (<>
            ...
            <div className="cart-edit des-cart" style={{ position: "relative", height: "10px", justifyContent: "center", alignItems: "center" }}><Link className='nav-link' to="/cart"><h4>Cart</h4></Link>{cart.length > 0 && (
              <span
                style={{
                  position: "absolute",
                  top: "-5px",
            ...
            <button id='b2' onClick={logout}>Log Out</button></>) :
